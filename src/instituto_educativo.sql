...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2022 a las 04:10:04
...
INSERT INTO `cursos` (`id`, `id_tema`, `fecha_inicio`, `id_docente`, `nombre`, `fecha_fin`) VALUES
(1, 2, '2022-09-01', 1, NULL, NULL),
(2, 1, '2022-09-29', 2, NULL, NULL),
(3, 2, '2022-03-12', 3, 'Curso TEst', '2022-04-12'),
(4, 2, '1212-11-11', 3, 'Teesto del curso', '2222-03-31');
...
INSERT INTO `material` (`id`, `titulo`, `costo`, `id_tema`) VALUES
(1, 'Manual de Calidad', 250, 1),
(2, 'Manual de XP', 250, 2),
(3, 'Lapiz óptico', 830, 1),
(4, 'Diccionario', 200, 2),
(5, 'Manual de Calidad 2', 250, 1);
